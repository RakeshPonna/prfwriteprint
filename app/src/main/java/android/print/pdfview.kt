...
import com.rocky.prfwriteprint.BuildConfig
import com.rocky.prfwriteprint.R
import java.io.File
...
object PdfView {
    ...
    private fun fileChooser(activity: Activity, path: String) {
        ...
        val uri = FileProvider.getUriForFile(activity, BuildConfig.APPLICATION_ID+"fileproviders", file)
